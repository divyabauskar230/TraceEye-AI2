...
export default function Home() {
  ...
  // 🟢 ॲड केलेले: Render सर्व्हर बॅकग्राउंडला पिंग करणे आणि युजर लॉगिन चेक करणे
  useEffect(() => {
    // १. Render सर्व्हर स्लीप मोड टाळण्यासाठी बॅकग्राउंड पिंग
    fetch("https://footpryx-backend.onrender.com/", { method: "GET", mode: "no-cors" })
      .catch((err) => console.log("Wake-up ping sent"));

    // २. युजर आधीच लॉग्ड इन असेल तर थेट डॅशबोर्डवर पाठवा
...
function ResultExampleComponent() {
  ...
  return (
    <div className="mt-8 max-w-5xl mx-auto space-y-4">
      <div className="bg-gray-950/90 border border-gray-800/90 rounded-3xl p-6 md:p-8 text-left space-y-6 shadow-2xl relative overflow-hidden min-h-[300px]">
        <p className="text-gray-400 text-xs text-center">Interactive Graph & Data View Loaded Successfully</p>
      </div>
    </div>
  );
}